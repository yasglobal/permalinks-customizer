...
class Permalinks_Customizer_Common_Functions {
	...
	public function permalinks_customizer_tablenav( $order_by_class, $order_by, $search_permalink, $page_url = 'permalinks-customizer-post-permalinks' ) {
		$nav = '<tr>
								...
								<th scope="col" id="title" class="manage-column column-title column-primary sortable ' . $order_by_class . '"><a href="/wp-admin/admin.php?page=' . $page_url . '&orderby=title&order=' .  $order_by . $search_permalink . '"><span>' . __( "Title", "permalinks-customizer" ) . '</span><span class="sorting-indicator"></span></a></th>
